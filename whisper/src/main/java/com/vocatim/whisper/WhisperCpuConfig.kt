...
/**
 * Picks a thread count matching the device's high-performance cores.
 * Using the little cores as well typically slows inference down.
 * Adapted from whisper.cpp examples/whisper.android.
 */
